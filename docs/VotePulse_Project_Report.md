...
### Key Features
- **Real-Time 6-Digit OTP Engine**: Generates dynamic 6-digit OTP codes with automatic focus advancement, 5-minute security countdown timer, and push alert toast notifications.
...
2. **Step 2 (OTP Generation & Alert)**: System verifies credentials and generates a 6-digit OTP code displayed via a floating alert toast notification.
