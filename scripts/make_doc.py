...
def main():
    ...
    add_bullet_item(doc, "Real-Time OTP Verification Engine", "Integrates a 6-digit auto-advancing OTP verification system with dynamic SMS/push alert toasts, and a 5-minute security countdown to guarantee authentic voter identification.")
