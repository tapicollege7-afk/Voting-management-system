...
def main():
    ...
    add_bullet_item(doc, "Real-Time 6-Digit OTP Engine", "Generates dynamic 6-digit OTP codes with automatic focus advancement, 5-minute security countdown timer, and push alert toast notifications.")
    ...
    add_bullet_item(doc, "Step 2 (OTP Generation & Alert)", "System verifies credentials and generates a 6-digit OTP code displayed via a floating alert toast.")
...
+-----------------------------------------------------------------------------------+""")
    ...
    add_code_block(doc, """[Voter Inputs Credentials] --> [Post /api/auth/login] --> [Credentials Valid?]
                                   ...
                                   [Generate 6-Digit OTP]                   [Return 401 Error]
                                              |
                                              v
                                    [Push Floating Toast Notification]
                                              |
                                              v
