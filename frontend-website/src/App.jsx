        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
              ...
              <div style={{ fontSize: '1.25rem', fontWeight: 800, marginBottom: '0.25rem' }}>Install VotePulse App</div>
              <div style={{ fontSize: '0.8rem', opacity: 0.7 }}>Follow the steps below for your device</div>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div style={{
                background: 'rgba(255,255,255,0.07)', borderRadius: '12px', padding: '1rem',
              ...
              <div style={{
                ...
                <div style={{ fontSize: '0.8rem', opacity: 0.85, lineHeight: 1.6 }}>
                  Tap the <strong>⋮ menu</strong> → <strong>"Add to Home screen"</strong> → <strong>"Install"</strong>.
                </div>
              </div>
              <div style={{
                background: 'rgba(255,255,255,0.07)', borderRadius: '12px', padding: '1rem',
            ...
            <div style={{
              ...
              The install button appears automatically on your next visit.
            </div>
          </div>
        </div>
      )}
